...
function App(): React.JSX.Element {
    ...
    const linking = {
        ...
        config: {
            screens: {
                // 네스트된 네비게이터를 정의할 경우 올바른 타입으로 설정
                ...
                [strings.createGroupTradePostScreenName]:
                    'group-trade/create-post',
                ...
                [strings.updateBoardPostScreenName]:
                    'board/update-post/:postId',
                ...
                [strings.myGroupTradePostsScreenName]:
                    'profile/group-trade-posts',
            },
        },
    }
